...
mod parity_tests {
    ...
    fn test_ffmpeg_flag_order_parity() {
        ...
        let args: Vec<String> = cmd.get_args().map(|s: &std::ffi::OsStr| s.to_string_lossy().to_string()).collect();
