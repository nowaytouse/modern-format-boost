...
mod integration_tests {
    ...
    fn get_test_media_dir() -> PathBuf {
        ...
        PathBuf::from(cargo_manifest).join("tests").join("edge")
    }
    ...
    #[test]
    fn smoke_check_video_media_files_generated() {
        let files = vec![
            "test_h264_10s.mp4",
            "test_vp9_5s.webm",
            "test_hevc_8s.mp4",
    ...
    #[test]
    fn smoke_check_gif_media_files_generated() {
    ...
    #[test]
    fn smoke_check_media_manifest_documentation() {
        ...
        let content = std::fs::read_to_string(&manifest)
            .unwrap_or_else(|e| panic!("Should read manifest: {e:?}"));
    ...
    #[test]
    fn smoke_check_all_major_codecs_represented() {
        let codecs = vec![
    ...
    #[test]
    fn smoke_check_media_files_are_readable() {
        let test_files = vec![
    ...
    #[test]
    fn smoke_check_media_directory_structure() {
    ...
    #[test]
    fn smoke_check_crf_precision_video_coverage() {
    ...
    #[test]
    fn smoke_check_ssim_quality_grades_video_coverage() {
    ...
    #[test]
    fn smoke_check_zero_gains_duration_coverage() {
