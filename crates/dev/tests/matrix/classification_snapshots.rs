...
fn test_prores_debug_verdict_snapshot() {
    fn mock_sticker_profile() -> LoopMeta {
        LoopMeta {
            ...
            duration_tier: Some(foundation::loop_intent::DurationTier::from_secs(1.5)),
            width: Some(400),
            height: Some(400),
            fps: Some(12.0),
            frame_count: Some(18),
    ...
    let verdict = foundation::assess_loop_intent_from_meta(&meta, None);
...
fn test_definitively_long_verdict_snapshot() {
    fn mock_definitively_long_profile() -> LoopMeta {
        LoopMeta {
            ...
            duration_tier: Some(foundation::loop_intent::DurationTier::from_secs(45.0)),
            width: Some(1920),
            height: Some(1080),
            fps: Some(30.0),
...
fn test_meme_verdict_snapshot() {
    fn mock_meme_profile() -> LoopMeta {
        LoopMeta {
            ...
            duration_tier: Some(foundation::loop_intent::DurationTier::from_secs(3.5)),
            width: Some(640),
            height: Some(640),
            fps: Some(30.0),
...
fn test_long_clip_verdict_snapshot() {
    fn mock_long_clip_profile() -> LoopMeta {
        LoopMeta {
            ...
            duration_tier: Some(foundation::loop_intent::DurationTier::from_secs(18.5)),
            width: Some(1920),
            height: Some(1080),
            fps: Some(30.0),
...
fn test_silent_technical_verdict_snapshot() {
    fn mock_silent_technical_profile() -> LoopMeta {
        LoopMeta {
            ...
            duration_tier: Some(foundation::loop_intent::DurationTier::from_secs(18.20)),
            width: Some(1920),
            height: Some(1080),
            fps: Some(30.0),
