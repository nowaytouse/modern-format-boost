...
fn test_sers_truncation_defense() {
    ...
    let path = Path::new("crates/dev/tests/edge/images/poison_pill_grayscale_icc.jpg");
...
fn test_exiftool_argument_injection_defense() {
    ...
    let path = Path::new("crates/dev/tests/edge/images/poison_pill_exiftool_-execute.jpg");
