...
This directory contains synthetic test media assets for the `modern_format_boost` development and integration test suite.
...
| `test_vp9_5s.webm`           | VP9 silent animation candidate                   | VP9        | 5s       |
...
| `test_short_2s.mp4`          | Short sub-threshold loop candidate               | H.264/AVC  | 2s       |
...
_Created by Modern Format Boost CI/CD_
