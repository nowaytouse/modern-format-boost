...
//! | Module | Role |
//! |--------|------|
//! | [`queue`](DispatchQueue) | Serial/concurrent queues, `dispatch_main` |
//! | [`source`](DispatchSource) | Event sources (timer, signal, I/O, …) |
//! | [`data`](DispatchData) | Contiguous/non-contiguous data objects |
//! | [`group`](DispatchGroup) | Task groups |
//! | [`semaphore`](DispatchSemaphore) | Counting semaphores |
//! | [`once`](DispatchOnce) | One-time initialization |
//! | [`time`](DispatchTime) | Time intervals and deadlines |
//! | [`block`](DispatchBlock) | Heap block objects (`dispatch_block_*`) |
//! | [`introspection`] | Debugger/introspection hooks |
//!
//! Raw C functions generated from Dispatch headers live in the private `generated`
//! module; safe wrappers are provided on the types above.
//!
...
#[cfg(feature = "block2")]
pub use self::block::DispatchBlock;
...
pub use self::generated::{
    ...
    DispatchAutoReleaseFrequency, DISPATCH_API_VERSION,
};
...
pub use self::introspection::{
    ...
    dispatch_introspection_hook_queue_item_dequeue, dispatch_introspection_hook_queue_item_enqueue,
};
pub use self::io::{
...
pub use self::object::{
    DispatchActivationGuard, DispatchObject, DispatchQoS, DispatchSuspendGuard,
    QualityOfServiceClassFloorError, QOS_MIN_RELATIVE_PRIORITY,
};
...
pub use self::time::{DispatchTime, DispatchTimeInterval, DispatchWallTime};
pub use self::workloop::DispatchWorkloop;

/// Swift-style shorthand for [`DispatchQoS`].
pub type QoS = DispatchQoS;
