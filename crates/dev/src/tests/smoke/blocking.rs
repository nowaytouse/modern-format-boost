...
mod test_utils {
    ...
    pub(super) fn create_large_jpeg() -> Vec<u8> {
    ...
    pub(super) fn create_multi_frame_gif() -> Vec<u8> {
        let mut gif = Vec::new();
    ...
    pub(super) fn create_corrupted_png() -> Vec<u8> {
        let mut png = Vec::new();
    ...
    pub(super) const fn create_empty_file() -> Vec<u8> {
        Vec::new()
    }
