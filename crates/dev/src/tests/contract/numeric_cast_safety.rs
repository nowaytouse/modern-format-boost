...
mod numeric_cast_safety_tests {
    ...
    fn test_integer_multiplication_overflow_safety() {
        ...
        let grid_size_sq = grid_size
            ...
            .expect("Grid size should not overflow"); // audited: contract test assertion path; panic/expect is test-only failure signal
    ...
    fn test_division_patterns_no_defaults() {
        ...
        let count = 0_usize;
        let safe_div = 100.0 / numeric_cast::u64_to_f64(numeric_cast::usize_to_u64(count)).max(1.0);
