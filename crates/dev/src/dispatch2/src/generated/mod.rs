...
use crate::{
    dispatch_function_t, dispatch_object_s, dispatch_source_type_s, dispatch_source_type_t,
    DispatchData, DispatchGroup, DispatchIO, DispatchIOCloseFlags, DispatchIOIntervalFlags,
    DispatchIOStreamType, DispatchObject, DispatchOnce, DispatchQoS, DispatchQueue,
    DispatchQueueAttr, DispatchRetained, DispatchSemaphore, DispatchSource, DispatchTime,
    DispatchWorkloop,
};
...
impl DispatchTime {
    ...
    #[must_use]
    #[inline]
    pub fn time(self, delta: i64) -> Self {
        extern "C" {
    ...
    #[must_use]
    #[inline]
    pub unsafe fn walltime(when: *const libc::timespec, delta: i64) -> Self {
        extern "C" {
...
impl DispatchQueue {
    ...
    #[must_use]
    #[inline]
    pub fn current() -> DispatchRetained<Self> {
        extern "C" {
...
impl DispatchQueueAttr {
    ...
    #[must_use]
    #[inline]
    pub fn new_initially_inactive(attr: Option<&Self>) -> DispatchRetained<Self> {
        extern "C" {
...
impl DispatchQueue {
    ...
    /// a `dispatch_queue_attr_make_with`_* function.
    ///
    ///
    ...
    #[must_use]
    #[inline]
    pub fn label(queue: Option<&Self>) -> NonNull<c_char> {
        extern "C" {
...
impl DispatchQueue {
    ...
    #[cfg(feature = "block2")]
    #[inline]
    pub unsafe fn exec_after_with_block(when: DispatchTime, queue: &Self, block: dispatch_block_t) {
        extern "C" {
...
impl DispatchGroup {
    ...
    #[must_use]
    #[inline]
    pub fn new() -> DispatchRetained<Self> {
        extern "C" {
...
impl DispatchSemaphore {
    ...
    #[must_use]
    #[inline]
    pub fn new(value: isize) -> DispatchRetained<Self> {
        extern "C" {
...
impl DispatchData {
    ...
    #[must_use]
    #[inline]
    pub fn concat(&self, data2: &Self) -> DispatchRetained<Self> {
        extern "C" {
    ...
    #[must_use]
    #[inline]
    pub unsafe fn subrange(&self, offset: usize, length: usize) -> DispatchRetained<Self> {
        extern "C" {
...
impl DispatchWorkloop {
    ...
    #[must_use]
    #[inline]
    pub(crate) unsafe fn __new(label: *const c_char) -> DispatchRetained<Self> {
        extern "C" {
    ...
    #[must_use]
    #[inline]
    pub(crate) unsafe fn __new_inactive(label: *const c_char) -> DispatchRetained<Self> {
        extern "C" {
