...
pub fn handle_error<E: std::error::Error + Send + Sync + 'static>(
    ...
    let suggestion_str = crate::media_conversion_gate::optional_nonempty_label(
        "error_suggestion",
        suggestion,
...
pub fn report_error<E: std::error::Error + ?Sized>(error: &E) {
    ...
    crate::media_conversion_gate::delivery_runtime_batch_audit("delivery_runtime_error", &msg);
}
