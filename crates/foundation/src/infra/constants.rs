...
pub const JXL_ARG_RESPONSIVE_DISABLED: &str = "--responsive=0";
pub const JXL_ARG_ADAPTIVE_NOISE_DISABLED: &str = "--noise=0";
pub const JXL_ARG_PHOTON_NOISE_DISABLED: &str = "--photon_noise_iso=0";
