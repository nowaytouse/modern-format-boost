...
impl DetectedCodec {
    ...
    pub fn from_ffprobe(codec_name: &str) -> Self {
        match codec_name.to_lowercase().as_str() {
            ...
            "hevc" | crate::constants::CODEC_H265 | crate::constants::ENCODER_X265 => Self::H265,
            crate::constants::CODEC_AV1
            | crate::constants::ENCODER_AOM_AV1
            | crate::constants::ENCODER_SVT_AV1 => Self::AV1,
            crate::constants::CODEC_VP9 | crate::constants::ENCODER_VP9 => Self::VP9,
            "vvc" | "h266" | "libvvenc" => Self::VVC,
            crate::constants::CODEC_H264
            | crate::constants::CODEC_AVC
            | crate::constants::ENCODER_X264 => Self::H264,
            crate::constants::CODEC_VP8 | crate::constants::ENCODER_VP8 => Self::VP8,
            "mpeg4" | "xvid" | "divx" => Self::MPEG4,
            "mpeg2video" => Self::MPEG2,
            "mpeg1video" => Self::MPEG1,
            "wmv1" | "wmv2" | "wmv3" | "vc1" => Self::WMV,
            crate::constants::CONTAINER_GIF => Self::GIF,
            crate::constants::CONTAINER_APNG => Self::APNG,
            crate::constants::CONTAINER_WEBP => Self::WebPAnim,
