...
#[test]
fn cjxl_failure_marks_conversion_error() {
    ...
    let _cjxl_path = {
        ...
        fs::write(&p, "@echo JPEG XL encoder v0.11.2 && exit /b 1").unwrap();
        p
    };
    ...
    fs::write(&input_path, vec![0xFFu8, 0xD8, 0xFF, 0xE0]).unwrap();
    ...
    assert!(res.is_err(), "conversion unexpectedly succeeded");
