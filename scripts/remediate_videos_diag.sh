...
SRC_BASE="/Users/user/Downloads/all/1"
OUT_BASE="/Users/user/Downloads/all/1_optimized"
LIST="/Users/user/Downloads/GitHub/modern_format_boost/vidquality_hevc/diff_videos_1.list"
BIN="/Users/user/Downloads/GitHub/modern_format_boost/target/release/vidquality-hevc"

echo "Starting Video Remediation for $(wc -l < $LIST) files..."

# Ensure binary is ready
(cd /Users/user/Downloads/GitHub/modern_format_boost && cargo build --release -p vidquality-hevc)
