    ...
    if OS_TYPE == "darwin":
        if command_exists("brew"):
            ...
            if pg_service:
                ...
                print_c(
                    YELLOW,
                    "⚠️  No PostgreSQL service found in 'brew services'. Trying to install default...",
                )
...
def setup_db():
    ...
    if res.returncode != 0:
        ...
        print(
            "Try: brew install pgvector (macOS) or refer to your Linux distribution's pgvector package."
        )
        sys.exit(1)
