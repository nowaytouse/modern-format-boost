...
# 查找小文件（更容易触发容差）
SMALL_JPG=$(find "/Users/nyamiiko/Downloads/all/闷茶子新" -name "*.jpg" -size +50k -size -200k | head -1)
MEDIUM_JPG=$(find "/Users/nyamiiko/Downloads/all/闷茶子新" -name "*.jpg" -size +200k -size -500k | head -1)
