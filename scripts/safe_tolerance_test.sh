...
# 查找JPG文件
JPG_FILE=$(find "/Users/nyamiiko/Downloads/all/闷茶子新" -name "*.jpg" | head -1)
PNG_FILE=$(find "/Users/nyamiiko/Downloads/all/闷茶子新" -name "*.png" | head -1)
GIF_FILE=$(find "/Users/nyamiiko/Downloads/all/闷茶子新" -name "*.gif" | grep -v "(" | head -1)
