...
**See also:** [README layer contracts](../../README.md#-layer-contracts--training) · [CHANGELOG](../CHANGELOG.md)

## Core invariants

| ID  | Invariant                                                                                                                                                                                                            | Enforcement                                                                                                                        |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| I1  | Runtime gates read `MODERN_FORMAT_DISABLE_*` only (via [`algorithm_runtime.rs`](../../crates/foundation/src/algo/algorithm_runtime.rs))                                                                              | `algorithm_runtime_rejects_legacy_enable_env_keys`, `algorithm_modules_reject_legacy_enable_env_reads`                             |
| I2  | Unit probabilities are finite and in \[0,1\]; non-finite rejected                                                                                                                                                    | [`algorithm_seal.rs`](../../crates/foundation/src/algo/algorithm_seal.rs) + `algorithm_modules_reject_forbidden_numeric_fallbacks` |
...
Defined in [`003_inference_runtime_verdict_views.sql`](../../crates/dev/src/migrations/003_inference_runtime_verdict_views.sql) and [`004_loop_inference_posterior_views.sql`](../../crates/dev/src/migrations/004_loop_inference_posterior_views.sql), applied by [`multi_scenario_db.rs`](../../crates/foundation/src/db/multi_scenario_db.rs).
