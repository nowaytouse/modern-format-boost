...
| 9      | tortoise    | Slow                                       |
| 10     | glacier     | Expert                                     |
| 11     | _(unnamed)_ | Expert (requires `--allow_expert_options`) |

Official documentation for effort 11:

> _"the only expert option is setting an effort value of 11, which gives the best compression for pixel-lossless modes but is very slow."_
...
### 3.1 4K Complex Image (3840×2160)
...
| e11    | _(timeout >10 min)_ | <0.04 MP/s | extreme  |
