...
| **Three-Phase Precision Search** | Adaptive CRF search: 0.5 → 0.25 → 0.1 step progression |
...
| **三阶段精度搜索** | 自适应CRF搜索：0.5 → 0.25 → 0.1 步进递进 |
...
│ 🎯 目标: 最高 SSIM + 输出 < 输入 │ CRF 范围: [18.0, 28.0] │
╰─────────────────────────────────────────────────────────────────────────╯
│ Phase 1 (0.5步) │ CRF 18.0 │ +5.2% ❌ │ Iter 1 │ Best: CRF 0.0 │ ⏱️ 2.3s │
│ Phase 2 (0.25步) │ CRF 23.0 │ -12.3% ✅ │ Iter 5 │ Best: 23.0 │ ⏱️ 8.1s │
│ Phase 3 (0.1步) │ CRF 22.8 │ -14.1% ✅ │ Iter 8 │ Best: 22.8 │ ⏱️ 12.5s │
╭─────────────────────────────────────────────────────────────────────────╮
│ 📊 结果: CRF 22.8 │ SSIM 0.9823 ✅ 良好 │ -15.2% │ 节省 0.38 MB │
│ 📈 迭代: 8 次 │ SSIM 计算: 1 次 │ 耗时: 12.5s │
╰─────────────────────────────────────────────────────────────────────────╯
```
